...
public:
    static VObject* parse(const char* buffer);
...
private:
    ...
    static char* extractObjectProperty(const char* buffer, const char *property,
    ...
    static char* extractObjectType(const char* buffer);
    static char* extractObjectVersion(const char* buffer);
