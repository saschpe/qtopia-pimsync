...
class DMTClientConfig : public SyncManagerConfig {
    ...
    protected:
        ...
        /* top level functions */
        virtual int readAccessConfig(ManagementNode& n);
        virtual void saveAccessConfig(ManagementNode& n);
        virtual int readDeviceConfig(ManagementNode& n);
        virtual void saveDeviceConfig(ManagementNode& n);
        virtual int readSourceConfig(int i, ManagementNode& n);
         ...
         */
        virtual int readSourceVars(int i,
                                    ManagementNode& sourcesNode,
         ...
         * @param sourceNode     the "spds/sources/<source name>" node
         */
        virtual int readSourceConfig(int i,
                                      ManagementNode& sourcesNode,
                                      ManagementNode& sourceNode);
    ...
    public:
        ...
        SyncSourceConfig* getSyncSourceConfig(const char* name, int refresh = 0);
        SyncSourceConfig* getSyncSourceConfig(unsigned int i,   int refresh = 0);
