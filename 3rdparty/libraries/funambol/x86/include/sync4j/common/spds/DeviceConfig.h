 ...
 *                If utc = 1, the server SHOULD send time in UTC format,
 *                else MUST send in local time. Default value = 1.
...
class DeviceConfig {
    ...
    public:
        ...
        int getLoSupport() const              ;
        void setLoSupport(int v)              ;

        int getNocSupport() const             ;
        void setNocSupport(int v)             ;
