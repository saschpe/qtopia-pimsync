...
/** @cond DEV */
    ...
    public:
         ...
         */
        int changeDataEncoding(const char* encoding, const char* encryption, const char* credentialInfo = 0);
       ...
       /**
        ...
        struct encodings {
            ...
            static const int isSupported(const char* encoding) {
      ...
      private:
        ...
        int transformData(const char* name, int encode, const char* password);
    };
