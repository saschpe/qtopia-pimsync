...
class SyncManagerConfig {
    protected:
        ...
        virtual int addSyncSourceConfig(SyncSourceConfig& sc);
    ...
    public:
        ...
        virtual SyncSourceConfig* getSyncSourceConfig(const char*  name, int refresh = 0);
        virtual SyncSourceConfig* getSyncSourceConfig(unsigned int i,    int refresh = 0);
		virtual int setSyncSourceConfig(SyncSourceConfig& sc);
