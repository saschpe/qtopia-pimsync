...
class AccessConfig {
    ...
    public:
         ...
         */
        int getUseProxy() const;

        /**
         * Sets if the sync engine should use a HTTP proxy to access the server.
         *
         * @param useProxy 0 for not use a proxy, 1 otherwise
         */
        ...
        int getServerAuthRequired() const;

        void setServerAuthRequired(int v);
        ...
        void setCheckConn(int v);
        int getCheckConn() const;
