...
/** @cond DEV */
    ...
    public:
        ...
        Log(int reset = 0, const char*  path = 0, const char*  name = 0);
        ~Log();
        ...
        void reset(const char*  title = 0);

        void setLevel(LogLevel level);

        LogLevel getLevel();

        int isLoggable(LogLevel level);

		/// Returns the log file size [bytes].
        size_t getLogSize();

        // FIXME!
        //void printMessageW(const char* level, const char* msg, va_list argList);
