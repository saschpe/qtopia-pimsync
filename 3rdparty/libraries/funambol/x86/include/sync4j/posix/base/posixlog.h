 ...
 *                        logging to stdout
 * @param redirectStderr  if 1, then file descriptor 2 (stderr)
 ...
 */
void setLogFile(const char *path, const char* name, int redirectStderr = 0);

/** traditional version of setLogFile() which writes in the current directory */
void setLogFile(const char* name, int redirectStderr = 0);
