...
class AbstractSyncSourceConfig2 : public SyncSourceConfig
{
public:
    enum Mode {
        Slow = 0x0,
    ...
    AbstractSyncSourceConfig2(Mode syncMode = Slow, unsigned int lastSync = 0, const char *uri = "default")
        : SyncSourceConfig()
    {
        setURI(uri);
...
{
public:
    AbstractSyncSource(AbstractSyncSourceConfig2 *config, SyncManagerConfig* managerConfig);
