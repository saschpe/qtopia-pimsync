...
void PimSync::addDefaultProfiles()
{
    ...
    profile()->setSourceUrl(ServerConfig::Contacts, "card");
    profile()->setSourceUrl(ServerConfig::Tasks, "task");
    profile()->setSourceUrl(ServerConfig::Appointments, "event");
    profile()->setSourceUrl(ServerConfig::Notes, "note");
    ...
    profile()->setSourceUrl(ServerConfig::Contacts, "card");
    profile()->setSourceUrl(ServerConfig::Tasks, "task");
    profile()->setSourceUrl(ServerConfig::Appointments, "cal");
    profile()->setSourceUrl(ServerConfig::Notes, "note");
    ...
    profile()->setSourceUrl(ServerConfig::Tasks, "task");
    profile()->setSourceUrl(ServerConfig::Appointments, "event");
    profile()->setSourceUrl(ServerConfig::Notes, "");
    profile()->setTransportUser("");
    profile()->setTransportPassword("");
    ...
    profile()->setSourceUrl(ServerConfig::Contacts, "con");
    profile()->setSourceUrl(ServerConfig::Tasks, "task");
    profile()->setSourceUrl(ServerConfig::Appointments, "cal");
    profile()->setSourceUrl(ServerConfig::Notes, "vnote");
    profile()->setTransportUser("");
    profile()->setTransportPassword("");
